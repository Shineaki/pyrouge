...
import pyrouge.components.ai
import pyrouge.components.inventory
from pyrouge.actions import ItemAction
from pyrouge.components.base_component import BaseComponent
from pyrouge.exceptions import Impossible
from pyrouge.input_handlers import (ActionOrHandler, AreaRangedAttackHandler,
...
class ConfusionConsumable(Consumable):
    ...
    def get_action(self, consumer: Actor) -> SingleRangedAttackHandler:
        self.engine.message_log.add_message(
            "Select a target location.", pyrouge.color.needs_target
        )
    ...
    def activate(self, action: ItemAction) -> None:
        ...
        self.engine.message_log.add_message(
            ...
            pyrouge.color.status_effect_applied,
        )
        target.ai = pyrouge.components.ai.ConfusedEnemy(
