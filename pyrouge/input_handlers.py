...
from pyrouge.actions import (Action, BumpAction, DropItem, EquipAction,
                             PickupAction, TakeStairsAction, WaitAction)

if TYPE_CHECKING:
    from pyrouge.engine import Engine
    from pyrouge.entity import Item
...
class EventHandler(BaseEventHandler):
    ...
    def handle_action(self, action: Optional[Action]) -> bool:
        ...
        try:
            action.perform()
        except pyrouge.exceptions.Impossible as exc:
            self.engine.message_log.add_message(
                exc.args[0], pyrouge.color.impossible)
...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        ...
        if 0 <= index <= 2:
            ...
            self.engine.message_log.add_message(
                "Invalid entry.", pyrouge.color.invalid)
...
class SelectIndexHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        ...
        console.rgb["bg"][x, y] = pyrouge.color.white
        console.rgb["fg"][x, y] = pyrouge.color.black
...
class GameOverEventHandler(EventHandler):
    def on_quit(self) -> None:
        ...
        raise pyrouge.exceptions.QuitWithoutSaving()
